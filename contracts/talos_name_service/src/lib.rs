...
//! should call [`TalosNameService::event_schema_version`] to confirm the schema
//! major version before processing events.
//!
//! | Symbol     | Topics                    | Data              |
//! |------------|---------------------------|-------------------|
//! | `name_reg` | `(symbol, talos_id: u32)` | `(name: String)`  |
...
/// matches the value returned by [`TalosNameService::event_schema_version`].
...
/// [`TalosNameService::event_schema_version`] return this value unchanged.
